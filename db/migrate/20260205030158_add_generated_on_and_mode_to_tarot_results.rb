class AddGeneratedOnAndModeToTarotResults < ActiveRecord::Migration[7.2]
  ...
  def up
    add_column :tarot_results, :mode, :string
    add_column :tarot_results, :generated_on, :date
  ...
  def down
    ...
    remove_column :tarot_results, :generated_on
    remove_column :tarot_results, :mode
  end
end
